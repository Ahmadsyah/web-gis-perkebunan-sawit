          ...
          <div class="navbar-fixed">
            <nav class="teal darken-2">
              ...
              <div class="nav-wrapper">
                <a href="<?=base_url() ?>" class="brand-logo">WebGIS PT.Inti Kamparindo Sejahtera</a>
                <a href="#" data-target="mobile-nav" class="sidenav-trigger"><i class="material-icons">menu</i></a>
                <ul class="right hide-on-med-and-down">
                  <li><a href="#maps">Peta Detail</a></li>
                  <li><a href="#about">Detail Bidang</a></li>
          ...
          <div class="container">
            <div class="row">
               <?php foreach ($bidang as $b) { ?>
                <h3 class="center light gray-text text-darken-3">Peta <?=$b->bidang_nama ?></h3>
               <?php } ?>
                 <div id="mapid"></div>
            </div>
            <br><br><br><br>
        ...
        <div class="row">
          ...
          <?php } ?>
            ...
            <div class="col m12 light">
              <div>
                  <?php foreach ($bidang as $b) { ?>
                  <p style="text-align: center;"> <?=$b->bidang_keterangan ?></p>
                  <?php } ?>
                  <br><br>
           ...
           <?php } ?>
            <div class="row">
               <?php foreach ($dok as $d) { ?>
                <div class="col m4">
                      <img src="<?=base_url()?>assets/uploads/<?=$d->dokumentasi_gambar?>" style = "height :100%; width: 800px; "  class="responsive-img materialboxed"> <br>
                </div>
                 <?php } ?>
            </div>
        </div>
